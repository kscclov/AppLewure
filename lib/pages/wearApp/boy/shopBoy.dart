...
import 'package:lewure2_0/pages/wearApp/boy/cartforcartBoy.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

class shopBoy extends StatefulWidget {

  final String text;
  const shopBoy({super.key, required this.text});
...
class _shopBoyState extends State<shopBoy> {
  ...
  Future<dynamic> getProductList() async {
    List<dynamic> productList = await supabase.from("boyProduct")
    .select<List<dynamic>>()
