...
class fullCartPageBoy extends StatefulWidget {
  final String text;

  const fullCartPageBoy({super.key, required this.text});

  @override
  _fullCartPageBoyState createState() => _fullCartPageBoyState();
}

class _fullCartPageBoyState extends State<fullCartPageBoy> {
